...
import 'package:mahilasaarthi/view_models/vehicles.vm.dart';
...
import 'package:mahilasaarthi/widgets/list_items/vehicle.list_item.dart';
          ...
          body: CustomListView(
            ...
            itemBuilder: (ctx, index) {
              ...
              return VehicleListItem(
                vehicle: vehicle,
                onpress: () => vm.makeVehicleCurrent(vehicle),
